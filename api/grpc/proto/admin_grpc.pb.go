...
const (
	...
	AdminService_ListCatalogs_FullMethodName          = "/dnsscience.v1.AdminService/ListCatalogs"
	AdminService_ListCatalogMembers_FullMethodName    = "/dnsscience.v1.AdminService/ListCatalogMembers"
	...
	AdminService_WatchQueryEvents_FullMethodName      = "/dnsscience.v1.AdminService/WatchQueryEvents"
)
...
type AdminServiceClient interface {
	...
	// RFC 9432 catalog inspection
	ListCatalogs(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AdminListCatalogsResponse, error)
	ListCatalogMembers(ctx context.Context, in *AdminListCatalogMembersRequest, opts ...grpc.CallOption) (*AdminListCatalogMembersResponse, error)
	...
	WatchQueryEvents(ctx context.Context, in *WatchQueryEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[QueryEventMessage], error)
}
...
func (c *adminServiceClient) ListCatalogs(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AdminListCatalogsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminListCatalogsResponse)
	err := c.cc.Invoke(ctx, AdminService_ListCatalogs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) ListCatalogMembers(ctx context.Context, in *AdminListCatalogMembersRequest, opts ...grpc.CallOption) (*AdminListCatalogMembersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminListCatalogMembersResponse)
	err := c.cc.Invoke(ctx, AdminService_ListCatalogMembers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) WatchQueryEvents(ctx context.Context, in *WatchQueryEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[QueryEventMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AdminService_ServiceDesc.Streams[0], AdminService_WatchQueryEvents_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[WatchQueryEventsRequest, QueryEventMessage]{ClientStream: stream}
...
type AdminService_WatchQueryEventsClient = grpc.ServerStreamingClient[QueryEventMessage]
...
type AdminServiceServer interface {
	...
	// RFC 9432 catalog inspection
	ListCatalogs(context.Context, *emptypb.Empty) (*AdminListCatalogsResponse, error)
	ListCatalogMembers(context.Context, *AdminListCatalogMembersRequest) (*AdminListCatalogMembersResponse, error)
	// Connection management
	...
	// Real-time query stream
	WatchQueryEvents(*WatchQueryEventsRequest, grpc.ServerStreamingServer[QueryEventMessage]) error
...
func (UnimplementedAdminServiceServer) ListCatalogs(context.Context, *emptypb.Empty) (*AdminListCatalogsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListCatalogs not implemented")
}
func (UnimplementedAdminServiceServer) ListCatalogMembers(context.Context, *AdminListCatalogMembersRequest) (*AdminListCatalogMembersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListCatalogMembers not implemented")
}
...
func (UnimplementedAdminServiceServer) WatchQueryEvents(*WatchQueryEventsRequest, grpc.ServerStreamingServer[QueryEventMessage]) error {
	return status.Error(codes.Unimplemented, "method WatchQueryEvents not implemented")
}
...
func _AdminService_ListCatalogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).ListCatalogs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_ListCatalogs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).ListCatalogs(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _AdminService_ListCatalogMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminListCatalogMembersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).ListCatalogMembers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_ListCatalogMembers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).ListCatalogMembers(ctx, req.(*AdminListCatalogMembersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AdminService_WatchQueryEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(WatchQueryEventsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AdminServiceServer).WatchQueryEvents(m, &grpc.GenericServerStream[WatchQueryEventsRequest, QueryEventMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AdminService_WatchQueryEventsServer = grpc.ServerStreamingServer[QueryEventMessage]
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AdminService_ListCatalogs_Handler,
		},
		{
			MethodName: "ListCatalogMembers",
			Handler:    _AdminService_ListCatalogMembers_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "WatchQueryEvents",
			Handler:       _AdminService_WatchQueryEvents_Handler,
			ServerStreams: true,
		},
	},
